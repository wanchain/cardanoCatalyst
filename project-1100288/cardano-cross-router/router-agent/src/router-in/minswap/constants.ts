...
import mainnetRouterInSingleSpend from "../../../../contract-router/compiled-mainnet/routerInSingleSpend.json";
import mainnetRouterInBatchSpend from "../../../../contract-router/compiled-mainnet/routerInBatchSpend.json";
import mainnetRouterInBatchStaking from "../../../../contract-router/compiled-mainnet/routerInStaking.json";

import mainnetCancellerStaking from "../../../../contract-router/compiled-mainnet/cancellerStaking.json";

import preprodRouterInSingleSpend from "../../../../contract-router/compiled-testnet/routerInSingleSpend.json";
import preprodRouterInBatchSpend from "../../../../contract-router/compiled-testnet/routerInBatchSpend.json";
import preprodRouterInBatchStaking from "../../../../contract-router/compiled-testnet/routerInStaking.json";

import preprodCancellerStaking from "../../../../contract-router/compiled-testnet/cancellerStaking.json";
